...
- Status: [ ] IN PROGRESS — **split into 3.5a (data plumbing, DONE) + 3.5b (the UI)** because the analytics types had to move to `shared` to cross IPC, and the plumbing is a clean, independently-testable unit. Built LAST in Phase 3 so it surfaces every already-built data feature.
- Zone: GREEN
